...
import { Link2, Plus, Copy, Check, Trash2, Eye, X, Lock, Mail, Calendar, User } from 'lucide-react'
      ...
      <div className="bg-white rounded-xl shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900">
            {createdLink ? 'Odkaz vytvořen' : 'Vytvořit veřejný odkaz'}
          </h3>
          ...
          <div className="p-6 space-y-4">
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              ...
              <p className="text-sm text-green-700">
                Sdílejte tento odkaz s uživatelem <strong>{createdLink.email}</strong>.
              </p>
            </div>
            ...
            {password && (
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
                ...
                <p className="text-xs text-amber-600 mt-1">Sdílejte heslo bezpečně (např. SMS nebo osobně).</p>
              </div>
            )}

            <div className="flex justify-end pt-2">
              <button
                onClick={() => { onCreated(createdLink); onClose() }}
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="form-input w-full"
                placeholder="Pro lepší zabezpečení"
              />
              <p className="text-xs text-gray-500 mt-1">Pokud je nastaveno, uživatel ho musí zadat pro přístup k formuláři.</p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="form-input w-full"
                placeholder="Např. poznámka o zákazníkovi"
              />
            </div>
